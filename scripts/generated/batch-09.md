...
**[HEAD FAKE]** "I found one built by one person, no ads, no investors to feed — so its whole pitch is: read the 50 things that matter, then close it. It has no reason to make me scroll. That's not generosity, it's just what happens when nobody profits from my boredom."
`[V: screen-record — a tight feed that visibly ends]`
**[REHOOK]** "Which made me realize how much of my day is spent inside things quietly optimized against me."
...
**[HEAD FAKE]** "The reframe that got me: 25 quid isn't another subscription, it's the one that replaces the reason you bought the others. One feed reading 5,000 posts a day, keeping the 50 with signal — cheaper than the check you pay just to mute people."
`[V: screen-record — one plain-English feed request resolving into signal]`
**[REHOOK]** "Made me wonder how much I pay every month just to make bad feeds hurt less."
...
**[HEAD FAKE]** "Now my morning is: open one feed, read everything in AI that mattered since yesterday, close it before my coffee's cold. Thirty seconds. The rest of the day I'm just... not wondering what I missed."
`[V: screen-record — a short lane-specific feed, scrolled once, closed]`
**[REHOOK]** "Turns out 'keeping up' was a full-time job I never actually needed to take."
...
**[HEAD FAKE]** "The one I use now literally ends. Reads 5,000 posts, keeps the 50 with signal, and when you're done, you're done — no infinite tail, no 'you might also like.' The pitch isn't 'stay.' It's 'get what matters and get out.'"
`[V: screen-record — feed hits a clean end-of-feed state]`
**[REHOOK]** "Weird that 'here's your time back' now sounds radical instead of normal."
